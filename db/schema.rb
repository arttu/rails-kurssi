...
ActiveRecord::Schema.define(:version => 20091211022227) do

  create_table "course_exam_registrations", :force => true do |t|
  ...
  create_table "exercise_groups", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "max_students", :default => 15
  end
  ...
  create_table "newsfeed_events", :force => true do |t|
    t.string   "text"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
